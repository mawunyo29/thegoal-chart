...
trait DataQuery
{
    ...
    public function __construct($rejectionColumns = [])
    {
        $this->rejectionColumns = $rejectionColumns;
    ...
    public function scopeModelFilterWithRelations(array $filters): Builder
    {
        ...
        $query->with($filters['relation'])->when(isset($filters['search']), function (Builder $query) use ($filters, $columns) {
