...
class DataBaseController extends Controller
{
    ...
    public function getModelRelationshipsColumns(): array
    {
        ...
        foreach ($relationships as $relationship) {
            $relationshipsColumns[] = $relationship->getConnection()
                ->getSchemaBuilder()
                ->getColumnListing($relationship->getTable());
        }
    ...
    public function getColumns(): self
    {
    ...
    public function getQuery(): JsonResponse
    {
    ...
    {
        // Implémentez votre logique ici pour obtenir le modèle actuel et la requête correspondante.
    }
}
