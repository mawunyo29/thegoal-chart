        ...
        <template v-if="displayStyle === 'table'">
                        ...
                        <div class="w-64">
                            <div class="flex flex-col p-2">
                                <div class="flex justify-between">
                                    ...
                                    <div class="text-sm font-medium text-gray-500 uppercase cursor-pointer" @click="rejectedKeys.value = []">Reset</div>
                                </div>
            ...
            <Tables>
                <template #tableheader>
                    <template v-for="(head, index) in headers">
                        <TableHead class="px-4 py-3 text-sm font-medium text-gray-500 uppercase"  v-if="!rejectedKeys.includes(key) "> 
                            {{ head }}
                        </TableHead>
                    </template>
                </template>
