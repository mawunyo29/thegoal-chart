        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="border-b border-gray-200" id="tab-navigator">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                        ...
                        <a href="#"
                            class="border-indigo-500 fa-solid fa-house text-gray-900 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm tab-navigator-link"
                            aria-current="page">
                            <i class=" tab-navigator-link"></i>
                        </a>
