<template>
    <div class="ring inline-flex  rounded-md max-h-8 max-w-64">
        <input type="text" class="appearance-none px-4 w-10 focus:w-40  border-0" v-model="searchInput" placeholder="search" role="search">
