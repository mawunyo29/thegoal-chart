                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="text-left border-b border-gray-200">
                                    <th class="px-4 py-3 text-sm font-medium text-gray-500" v-for="head in headings">{{ head }}</th>
                                </tr>
                            ...
                            <tbody>
                                <tr class="border-b border-gray-200 hover:bg-gray-100" v-for="user in filteredData"
                                    :key="user.id">
                                    <td class="px-4 py-3 text-sm font-medium text-gray-500">{{ user.id }}</td>
...
const rejectedKeys = ['id', 'created_at', 'updated_at' , 'email_verified_at'];
