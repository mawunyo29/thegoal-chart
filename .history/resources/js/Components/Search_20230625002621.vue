<template>
    <div class="container max-w-lg flex justify-end">
        <div class="ring inline-flex  rounded-md justify-end ">
            <div class="">
                <input type="text" class="appearance-none px-4 w-10 focus:w-40 transform ease-in-out duration-500 border-0" v-model="searchInput"
