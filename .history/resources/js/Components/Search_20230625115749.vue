<template>
    <div class=" sm:mx-8 container mx-auto">
        <div class="ring inline-flex  rounded-md justify-end ">
            <div class="">
                <input type="text"
                    class="appearance-none px-4 w-full focus:w-40 transform ease-in-out duration-500 border-0 h-8"
                    v-model="searchInput" placeholder="search" role="search">
            </div>

            <div class="flex justify-center  items-center bg-slate-300 px-2">
