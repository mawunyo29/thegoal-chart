        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="border-b border-gray-200" id="tab-navigator">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <a href="#"
                        class="  text-gray-900 whitespace-nowrap  px-1 border-b-2 font-medium text-sm tab-navigator-link  border-indigo-500"
                        aria-current="page">
                        <i class="fa-solid fa-house  border-indigo-500 tab-navigator-link"></i>
                    </a>

                    <a href="#"
                        class="border-transparent text-gray-500 hover:text-gray-700  whitespace-nowrap  px-1 border-b-2 font-medium text-sm tab-navigator-link">
                        Team
                    </a>
