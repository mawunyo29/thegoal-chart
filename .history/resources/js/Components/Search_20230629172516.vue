<template>
    <div class=" sm:mx-8 rounded-sm">
        ...
        <div>
            <div class="absolute z-50 bg-white w-full rounded-t-none shadow-lg mt-1 left-0 right-0 px-2"
                ...
                <div class="flex flex-col w-full bg-white rounded-md shadow-lg max-h-60 ">
                    ...
                    <div class="overflow-y-auto h-60 mt-5">
                        <table class="w-full">
                            <thead>
                                <tr class="text-left border-b border-gray-200 sticky top-0 bg-slate-950 text-white">
        ...
        <ResultsSearch displayDataStyle="table" />
    </div>
</template>
...
import ResultsSearch from '@/Components/SearchResults/ResultsSearch.vue';
...
onMounted(async () => {
    ...
    console.log(complexDataTable.value.data , 'complexDataTable', dataTable.value.data, 'dataTable');
